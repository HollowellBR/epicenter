<p align="center">
  <img width="180" src="./src-tauri/recorder-state-icons/studio_microphone.png" alt="Steno">
...
<p align="center">
  ...
  <a href="../../LICENSE" target="_blank">
    <img alt="AGPLv3 License" src="https://img.shields.io/badge/license-AGPL--3.0-blue?style=flat-square" />
  </a>
...
Steno is an open-source speech-to-text application. Press a keyboard shortcut, speak, and your words will transcribe, transform, then copy and paste at the cursor.
...
So I built Steno. It's open-source, local-first, and most importantly, transparent with your data. ​​Your data is stored locally on your device, and your audio goes directly from your machine to a local provider (Whisper C++, Speaches, etc.) or your chosen cloud provider (Groq, OpenAI, ElevenLabs, etc.) without any middleman or vendor lock-in. For me, the features were good enough that I left my paid tools behind (I used Superwhisper and Wispr Flow before).

Productivity apps should be open-source and transparent with your data, but they also need to match the UX of paid, closed-software alternatives. I hope Steno is near that point. I use it for several hours a day, from coding to thinking out loud while carrying pizza boxes back from the office.

> [!TIP]
> Steno is designed for quick transcriptions, not long recordings. For extended recording sessions, use a dedicated recording app.

Here's an overview:

<div align="center">
  <a href="https://www.youtube.com/watch?v=1jYgBMrfVZs">
    <img src="https://img.youtube.com/vi/1jYgBMrfVZs/maxresdefault.jpg" alt="Steno Complete Setup Guide" width="600">
  </a>
...
Set up Steno and be ready to transcribe in about two minutes.
...
The fastest way to install Steno on macOS:
...
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| **Apple Silicon** | [Steno_7.11.0_aarch64.dmg](https://github.com/StenoApp/steno/releases/download/v7.11.0/Steno_7.11.0_aarch64.dmg) | M1/M2/M3/M4 Macs |
| **Intel**         | [Steno_7.11.0_x64.dmg](https://github.com/StenoApp/steno/releases/download/v7.11.0/Steno_7.11.0_x64.dmg)         | Intel-based Macs |
...
3. Drag Steno to your Applications folder
4. Open Steno from Applications

#### Troubleshooting:

- **"Unverified developer" warning:** Right-click the app → Open → Open
- **"App is damaged" error (Apple Silicon):** Run `xattr -cr /Applications/Steno.app` in Terminal
...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- |
| **MSI Installer** | [Steno_7.11.0_x64_en-US.msi](https://github.com/StenoApp/steno/releases/download/v7.11.0/Steno_7.11.0_x64_en-US.msi) | Recommended Standard Windows installer |
| **EXE Installer** | [Steno_7.11.0_x64-setup.exe](https://github.com/StenoApp/steno/releases/download/v7.11.0/Steno_7.11.0_x64-setup.exe) | Alternative installer option           |
...
Steno will appear in your Start Menu when complete.
...
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
| **AppImage**    | [Steno_7.11.0_amd64.AppImage](https://github.com/StenoApp/steno/releases/download/v7.11.0/Steno_7.11.0_amd64.AppImage) | All Linux distributions  |
| **DEB Package** | [Steno_7.11.0_amd64.deb](https://github.com/StenoApp/steno/releases/download/v7.11.0/Steno_7.11.0_amd64.deb)           | Debian, Ubuntu, Pop!\_OS |
| **RPM Package** | [Steno-7.11.0-1.x86_64.rpm](https://github.com/StenoApp/steno/releases/download/v7.11.0/Steno-7.11.0-1.x86_64.rpm)     | Fedora, RHEL, openSUSE   |
...
```bash
wget https://github.com/StenoApp/steno/releases/download/v7.11.0/Steno_7.11.0_amd64.AppImage
chmod +x Steno_7.11.0_amd64.AppImage
./Steno_7.11.0_amd64.AppImage
```

**Debian/Ubuntu**

```bash
wget https://github.com/StenoApp/steno/releases/download/v7.11.0/Steno_7.11.0_amd64.deb
sudo dpkg -i Steno_7.11.0_amd64.deb
```

**Fedora/RHEL**

```bash
wget https://github.com/StenoApp/steno/releases/download/v7.11.0/Steno-7.11.0-1.x86_64.rpm
sudo rpm -i Steno-7.11.0-1.x86_64.rpm
```

</details>

> [!TIP]
> **Links not working?** Find all downloads at [GitHub Releases](https://github.com/StenoApp/steno/releases/latest)
...
**Open Steno Web App** (if hosted)

No installation needed! Works in any modern browser.

> **📝 Note:** The web version doesn't have global keyboard shortcuts, but otherwise works great for trying out Steno before installing.

</details>

### 2️⃣ Choose Your Transcription Method

Steno offers two approaches to transcription. Pick the one that fits your needs:
...
- **Shortcut not working?** → Bring Steno to foreground (see macOS section below)
...
2. Bring Steno to the foreground briefly to restore shortcuts
3. Keep the app window in the foreground (even as a smaller window)

**Best practice:** Keep Steno in the foreground in front of other apps. You can resize it to a smaller window or use Voice Activated mode for minimal disruption.
...
If you accidentally clicked "Don't Allow" when Steno asked for microphone access, here's how to fix it:

#### 🍎 macOS

1. Open **System Settings** → **Privacy & Security** → **Privacy** → **Microphone**
2. Find **Steno** in the list
3. Toggle the switch to enable microphone access
4. If Steno isn't in the list, reinstall the app to trigger the permission prompt again
...
3. Use Find (Ctrl+F) to search for "Steno"
4. Delete all registry folders containing "Steno"
5. Press F3 to find next, repeat until all instances are removed
6. Uninstall and reinstall Steno
7. Accept permissions when prompted

<details>
<summary>Alternative solutions</summary>

**Delete App Data:** Navigate to `%APPDATA%\..\Local\io.steno.app` and delete this folder, then reinstall.
...
- **Why:** Point Steno at any self-hosted or private LLMs you want
...
Steno stores as much data as possible locally on your device, including recordings and text transcriptions. This approach ensures maximum privacy and data security. Here's an overview of how data is handled:
...
3. **Transformation Service (Optional)**: Steno includes configurable transformation settings that allow you to pipe transcription output into custom transformation flows. These flows can leverage:
...
Most apps are middlemen charging $30/month for API calls that cost pennies. With Steno, you bring your own API key and pay providers directly. Your audio goes straight from your device to the API. No servers in between, no data collection, no subscriptions.
...
Note: we use anonymized event logging with [Aptabase](https://github.com/aptabase), an open-source, privacy-first analytics service. No personal data is attached to any of these events. You can see exactly what events we log in `analytics.ts` and where they are logged by searching for `rpc.analytics.logEvent` in the codebase. You can turn this off in settings at any time.
...
Desktop: Mac (Intel & Apple Silicon), Windows, Linux. Web: Any modern browser (when hosted).
...
Steno showcases the power of modern web development as a comprehensive example application:
...
Steno uses a clean three-layer architecture with 97% code sharing between desktop and web versions:
...
### Run Steno in Local Development Mode
...
Find the executable in `apps/steno/target/release`

### Contributing

We welcome contributions! Steno is built with care and attention to clean, maintainable code.
...
We'd love to expand Steno's capabilities with more transcription and AI service adapters! Here's how to add a new adapter:
...
AI transformations in Steno use completion services that can be integrated into transformation workflows. Here's how to add a new AI provider:
...
Always use the `StenoErr` helper for user-facing errors:
...
Feel free to suggest and implement any features that improve usability—I'll do my best to integrate contributions that make Steno better for everyone.

## Acknowledgments

### Local Transcription

Steno's local transcription capabilities are powered by amazing open-source projects:

- **[transcribe-rs](https://github.com/cjpais/transcribe-rs)** by [CJ Pais](https://github.com/cjpais) - A unified Rust library providing abstraction over multiple speech-to-text engines (Whisper and Parakeet). This library enables Steno to seamlessly support different transcription engines with a consistent API.

- **[Handy](https://github.com/cjpais/handy)** by [CJ Pais](https://github.com/cjpais) - The original project that birthed `transcribe-rs`. Handy is a an awesome cross-platform desktop speech-to-text application, and I personally use it especially when developing Steno locally.
...
Special thanks to [CJ Pais](https://github.com/cjpais) for creating and maintaining essential libraries that make local, privacy-preserving transcription possible in Steno.

## Support and Community

### License

Steno is released under the [AGPLv3 License](../../LICENSE). Fork it, modify it, build on top of it, make it yours.

### Support and Feedback

We're built in public, shaped by user feedback. If you encounter any issues or have suggestions for improvements, please open an issue on the GitHub issues tab. I really appreciate it!

- Feature Requests, Issues, and Bug Reports: GitHub Issues

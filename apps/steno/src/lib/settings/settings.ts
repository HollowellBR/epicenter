...
export const Settings = type({
	...
	// API keys for inference providers (used by transformation pipeline)
	...
	// Wake word settings
	'wakeword.enabled': 'boolean = false',
	'wakeword.scriptPath': "string = ''",
	'wakeword.threshold': "string = '0.5'",

	// Voice command settings
	'voiceCommands.enabled': 'boolean = false',
	'voiceCommands.prefixKeyword': "string = 'steno'",
	'voiceCommands.fuzzyThreshold': "string = '0.8'",
	'voiceCommands.prefixFuzzyEnabled': 'boolean = true',
	'voiceCommands.feedbackSound': 'boolean = true',
	...
	'llamacpp.model': "string = 'qwen3-8b'", // selected model id (see LLM_MODELS)
	'llamacpp.port': 'number = 8080',
	'llamacpp.contextSize': 'number = 4096',
	'llamacpp.gpuLayers': 'number = 99', // offload all layers if a GPU backend exists
	'llamacpp.defaultPrompt': "string = 'Fix grammar and punctuation'",

	// Ollama settings (optional local LLM backend)

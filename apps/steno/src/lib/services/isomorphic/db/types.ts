...
export type DbService = {
	...
	voiceCommands: {
		getAll(): Promise<Result<VoiceCommand[], DbServiceError>>;
		getById(id: string): Promise<Result<VoiceCommand | null, DbServiceError>>;
		create(
			command: VoiceCommand | VoiceCommand[],
		): Promise<Result<void, DbServiceError>>;
		update(command: VoiceCommand): Promise<Result<VoiceCommand, DbServiceError>>;
		delete(
			command: VoiceCommand | VoiceCommand[],
		): Promise<Result<void, DbServiceError>>;
		clear(): Promise<Result<void, DbServiceError>>;
	...
	shellAllowlist: {
		getAll(): Promise<Result<ShellAllowlistEntry[], DbServiceError>>;
		getById(
			id: string,
		): Promise<Result<ShellAllowlistEntry | null, DbServiceError>>;
		create(
			entry: ShellAllowlistEntry | ShellAllowlistEntry[],
		): Promise<Result<void, DbServiceError>>;
		update(
			entry: ShellAllowlistEntry,
		): Promise<Result<ShellAllowlistEntry, DbServiceError>>;
		delete(
			entry: ShellAllowlistEntry | ShellAllowlistEntry[],
		): Promise<Result<void, DbServiceError>>;
		clear(): Promise<Result<void, DbServiceError>>;

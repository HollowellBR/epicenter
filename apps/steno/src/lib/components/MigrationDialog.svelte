...
<script lang="ts">
	...
	// Auto-scroll logs to bottom after DOM updates
	$effect(() => {
	...
	<Dialog.Content class="max-h-[90vh] max-w-3xl overflow-y-auto">
		...
		<div class="space-y-6">
			...
			{#if import.meta.env.DEV}
				<div
					class="rounded-lg border border-dashed border-warning bg-warning/5 p-4"
				>
					<h3
						class="mb-3 text-sm font-semibold text-warning"
					>

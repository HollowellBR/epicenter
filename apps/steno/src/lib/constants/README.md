...
The `constants` directory serves as the centralized source of truth for all immutable values used throughout the Steno application. This includes configuration values, enumerations, type definitions, and any other values that remain constant during runtime.
...
export { STENO_URL, STENO_RECORDINGS_PATHNAME } from './urls';
...
import { STENO_URL } from '$lib/constants/app';
...
import { STENO_URL } from '$lib/constants/app/urls';

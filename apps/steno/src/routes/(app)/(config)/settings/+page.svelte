<script lang="ts">
	...
	import * as RadioGroup from '@steno/ui/radio-group';
...
<svelte:head>
	<title>Settings - Steno</title>
</svelte:head>

<Field.Set>
	<Field.Legend>General</Field.Legend>
	<Field.Description>
		Configure your general Steno preferences.
	</Field.Description>
	<Field.Separator />
	<Field.Group>
		<Field.Set>
		...
		{#if window.__TAURI_INTERNALS__}
			<Field.Field orientation="horizontal">
				<Field.Content>
					...
					<Field.Description>
						Automatically open Steno when you log in
					</Field.Description>
				</Field.Content>
				<Switch
					id="autostart"

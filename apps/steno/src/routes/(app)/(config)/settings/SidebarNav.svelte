<script lang="ts">
	...
	const items = [
		...
		{ title: 'Transformation', href: '/settings/transformation' },
		...
		{ title: 'Voice Commands', href: '/settings/voice-commands' },
		{ title: 'Wake Word', href: '/settings/wakeword' },
	] satisfies {
		title: string;
		href: string;
		/**
...
<nav
	class="flex flex-wrap gap-2 lg:flex-col lg:gap-1"

<script lang="ts">
	...
	import {
		...
		FileDropZone,
		MEGABYTE,
	} from '@steno/ui/file-drop-zone';
	import * as Kbd from '@steno/ui/kbd';
	import { Link } from '@steno/ui/link';
	import * as ToggleGroup from '@steno/ui/toggle-group';
	...
	<div class="xs:flex hidden flex-col items-center gap-3">
		...
		<p class="text-muted-foreground text-center text-sm font-light">
			{#if !window.__TAURI_INTERNALS__}
				...
				<Link
					tooltip="Get Steno for desktop"
					href="https://github.com/StenoApp/steno/releases"
					target="_blank"

...
This specification documents the implementation of Deepgram API support for speech-to-text transcription in the Steno application, with cross-platform compatibility for both web browsers and Tauri desktop environments.
